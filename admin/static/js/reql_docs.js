...
// hash: "8096e41fca51a565acfc9707c9cde5477b571d60"
reql_docs = {
  "api/javascript/add/": {
  ...
  "api/javascript/bitwise-and/": {
    "body": "value.bitAnd(value[, value, ...]) &rarr; value", 
    "description": "<p>Bitwise AND (&amp;) the bits of two or more numbers together, returning the binary result as a number.</p>", 
    "example": "<p><strong>Example:</strong> 55 &amp; 5 = 5</p>\n<pre><code>&gt; r.expr(55).bitAnd(5).run(conn, callback)\n// result passed to callback\n110111\n000101\n------\n000101\nIE. 5\n</code></pre>", 
    "io": [
      [
        "number", 
        "number"
  ...
  "api/javascript/bitwise-not/": {
    "body": "value.bitNot() &rarr; valuebitNot(number) %rarr; value", 
    "description": "<p>Bitwise NOT (~) the bits of a number together, returning the one's complement of that number.</p>", 
    "example": "<p><strong>Example:</strong> 55 ~ 5 = -56</p>\n<pre><code>&gt; r.expr(55).bitNot().run(conn, callback)\n// result passed to callback\n11 0111\n-------\n00 1000\nIE. -56\n</code></pre>", 
    "io": [
      [
        "number", 
        "number"
  ...
  "api/javascript/bitwise-or/": {
    "body": "value.bitOr(value[, value, ...]) &rarr; value", 
    "description": "<p>Bitwise OR (|) the bits of two or more numbers together, returning the binary result as a number.</p>", 
    "example": "<p><strong>Example:</strong> 55 | 5 = 55</p>\n<pre><code>&gt; r.expr(55).bitOr(5).run(conn, callback)\n// result passed to callback\n110111\n000101\n------\n110111\nIE. 55\n</code></pre>", 
    "io": [
      [
        "number", 
        "number"
  ...
  "api/javascript/bitwise-sal/": {
    "body": "value.bitSal(number) &rarr; valuebitSal(number, number) %rarr; value", 
    "description": "<p>Bitwise Shift Left (&lt;&lt;) the bits of one number with another, returning the shifted result of those numbers.</p>", 
    "example": "<p><strong>Example:</strong> 55 &lt;&lt; 5 = 1760</p>\n<pre><code>&gt; r.expr(55).bitSal(5).run(conn, callback)\n// result passed to callback\n110111 &lt;&lt; 5 -&gt; 11011100000\nIE. 1760\n</code></pre>", 
    "io": [
      [
        "number", 
        "number"
  ...
  "api/javascript/bitwise-sar/": {
    "body": "value.bitSar(number) &rarr; valuebitSar(number, number) %rarr; value", 
    "description": "<p>Bitwise Shift Right (&gt;&gt;) the bits of one number with another, returning the shifted result of those numbers.</p>", 
    "example": "<p><strong>Example:</strong> 55 &gt;&gt; 5 = 1</p>\n<pre><code>&gt; r.expr(55).bitSar(5).run(conn, callback)\n// result passed to callback\n110111 &gt;&gt; 5 -&gt; 000001\nIE. 1\n</code></pre>", 
    "io": [
      [
        "number", 
        "number"
  ...
  "api/javascript/bitwise-xor/": {
    "body": "value.bitXor(value[, value, ...]) &rarr; value", 
    "description": "<p>Bitwise XOR (\u2295) the bits of two or more numbers together, returning the binary result as a number.</p>", 
    "example": "<p><strong>Example:</strong> 55 \u2295 5 = 50</p>\n<pre><code>&gt; r.expr(55).bitXor(5).run(conn, callback)\n// result passed to callback\n110111\n000101\n------\n110010\nIE. 50\n</code></pre>", 
    "io": [
      [
        "number", 
        "number"
